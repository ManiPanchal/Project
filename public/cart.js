...
let procced=document.getElementById("order");
let sub_total=0;
...
request.addEventListener("load",()=>
{
    ...
    if(data.length==0)
    {
        procced.disabled=true;
        let product=document.getElementById("cart_prod");
        // product.style.background="url('emptycart.jpg')";
    ...
    for(let i=0;i<data.length;i++)
    {
        ...
        // let total=document.getElementById("total");
        if(data[i].quantity<data[i].curr_quantity)
        {
            let product=document.getElementById("cart_prod");
        ...
        p2.innerHTML="Product is Not Available";
        p2.style.color="Red";
        ...
        // buy.setAttribute("href","/buynow");
        // buy.innerHTML="Buy Now";
        // buy.setAttribute("class","button2");
    ...
    function del_from_cart(e)
    {
        ...
        request.addEventListener("load",()=>
        {
            ...
            //    console.log(document.getElementById("cart_prod").getElementsByTagName("p").length);
               if(document.getElementById("cart_prod").getElementsByTagName("p").length==0)
               {
                let product=document.getElementById("cart_prod");
                // product.style.background="url('emptycart.jpg')";
                let h2=document.createElement("h2");
